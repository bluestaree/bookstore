  ...
  <section id="main">
    <div class="container_12">
       ...
       <div id="content" class="grid_9">
	      <h1 class="page_title">搜索列表<span style="padding-left: 20px;font-size: 12px;color: #e0e0e0;">Search List</span></h1>
	      <div class="options">
		      <div class="grid-list">
			   <a class="grid curent" ><span>img</span></a>
		     	<div style="width: 180px;margin-top: 20px;margin-left: 80px;">按<font color="red"> "<s:property value="searchkey" />" </font> 搜索的结果</div>
		     </div><!-- .grid-list -->
			 <form id="formpage" action="${pageContext.request.contextPath}/product_search" method="post">
			     <div class="show">
				    	每页显示记录数
			      	<input type="hidden" id="_page" name="page" value="1" />
			      	<input type="hidden" id="_searchkey" name="searchkey" value="<s:property value="searchkey" />" />
				    <select id="limit"  name="limit">
					  <s:iterator begin="1" end="9" var="i">
						   ...
						   <s:else>
						   		<option selected="selected" value="<s:property value="#i" />"><s:property value="#i" /></option>
						   </s:else>
					   </s:iterator>
				     </select>
			     </div><!-- .show -->
	      ...
	      <!-- 分页  -->
		      <div class="pagination">
				     ...
				     <s:if test="pageBean.page != 1">
				     	<li class="prev"><a href="javascript:void(0);" onclick="searchPage(1)" >&lt;&lt;</a></li>
					    <li class="prev"><a href="javascript:void(0);" onclick="searchPage(<s:property value='pageBean.page - 1'/>)">&lt;</a></li>
					 </s:if>   
					 <!-- 动态显示条 -->
		       		 <s:iterator begin="pageBean.start" end="pageBean.end" var="num">
		       		 	<s:if test="pageBean.page != #num">
		        	  		<li><a href="javascript:void(0);" onclick="searchPage(<s:property value='#num'/>)" ><s:property value="#num"/></a></li>
		        	  	</s:if>
		        	  	<s:else>
					  ...
					  <s:if test="pageBean.page != pageBean.totalPage">  
					    <li class="next"><a href="javascript:void(0);" onclick="searchPage(<s:property value='pageBean.page + 1'/>)">&gt;</a></li>
					    <li class="next"><a href="javascript:void(0);" onclick="searchPage(<s:property value='pageBean.totalPage'/>)">&gt;&gt;</a></li>
					  </s:if>  
				     </ul>
		      </div><!-- .pagination -->
