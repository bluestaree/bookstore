...
<body>
  <div style="background-color: #E7E7E7;border-radius: 20px;padding: 5px;margin-right: 5px;margin-top: 5px;margin-left: 5px;">
	...
	<form id="form1" action="${pageContext.request.contextPath}/adminProduct_edit" method="post" enctype="multipart/form-data">
	...
	<table width="100%">
			<tbody>
				<tr>
				<td valign="top">
						<div class="title"><h2>编辑商品</h2></div>
						<div class="maincon">
					<table class="formtable" width="100%">
						<tr>
							<td width="180px" align="right"><span style="color: red">* </span>商品名称：</td>
							<td width="210px">
								<div class="stext"><input type="text" id="pname" name="pname" value="<s:property value="model.pname" />"  style="width:180px;" /><span id="pname_tip" style="margin-left: 15px;display: none;color: red"></span></div>
							</td>
						...
						<tr>
							...
							<td width="210px">
								<div class="stext"><input type="text" id="author" name="author" value="<s:property value="model.author" />"  style="width:120px;" /><span id="author_tip" style="margin-left: 15px;display: none;color: red"></span></div>
							</td>
							<td width="180px" align="right"><span style="color: red">* </span>出版社：</td>
							<td>
								<div class="stext"><input type="text" id="press" name="press" value="<s:property value="model.press" />"  style="width:120px;" /><span id="press_tip" style="margin-left: 15px;display: none;color: red"></span></div>
							</td>
						</tr>
						<tr>
							<td width="180px" align="right"><span style="color: red">* </span>市场价格：</td>
							<td width="210px">
								<div class="stext"><input type="text" id="market_price" name="market_price" value="<s:property value="model.market_price" />"  style="width:100px;" /><span id="market_price_tip" style="margin-left: 15px;display: none;color: red"></span></div>
							</td>
							<td width="180px" align="right"><span style="color: red">* </span>商城价格：</td>
							<td>
								<div class="stext"><input type="text" id="shop_price" name="shop_price" value="<s:property value="model.shop_price" />"  style="width:100px;" /><span id="shop_price_tip" style="margin-left: 15px;display: none;color: red"></span></div>
							</td>
						</tr>
						<tr>
							<td width="180px" align="right">商品图片：</td>
							<td width="210px">
							 <img align="left" height="40px" width="40px" src="${pageContext.request.contextPath}/<s:property value="model.image"/>"><input type="file" name="upload" style="width:180px;margin-top: 10px"><span id="shop_price_tip" style="margin-left: 15px;color: red"><s:fielderror /></span>
							</td>
						...
						<tr>
							...
							<td colspan="3">
								<div class="stext"><input type="text" id="spoint" name="spoint" value="<s:property value="model.spoint" />"  style="width: 580px;" /><span id="tip" style="margin-left: 15px;display: none;color: red"></span></div>
							</td>
						</tr>
						<tr>
							<td width="180px" align="right">内容简介：</td>
							<td width="210px">
								<textarea rows="6" cols="40" name="pdesc" ><s:property value="model.pdesc" /></textarea>
							</td>
							<td width="180px" align="right">作者简介：</td>
							<td>
								<textarea rows="6" cols="40" name="adesc"><s:property value="model.adesc" /></textarea>
							</td>
						</tr>
						 <tr align="center">
