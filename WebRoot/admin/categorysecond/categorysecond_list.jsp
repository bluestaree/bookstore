...
<script type="text/javascript">
	$(document).ready(function() {
		$("#add").click(function(){
			location.href = "${pageContext.request.contextPath}/adminCategorySecond_addPage";
		});
	});
</script>
...
<body>
  <div style="background-color: #E7E7E7;border-radius: 20px;padding: 5px;margin-right: 5px;margin-top: 5px;margin-left: 5px;">
            ...
            <a style="margin-left: 15px;margin-right: 15px;">二级分类管理</a>
			...
			<td height="100%" bgcolor="#ffffff">
				<table width="100%" height="100%" >
					<tbody>
						<tr> 
							<td valign="top">
								<div class="title"><h2>二级分类列表</h2></div>
								<div class="maincon">
									<div align="right"> <span style="margin-right: 30px;font-size:  14px;">总记录数  ：  <s:property value="pageBean.totalCount"/></span><button id="add" style="margin-bottom: 10px;margin-right: 20px;width: 89px;height: 35px; line-height: 35px; cursor: pointer; 
									...
									<table class="tablelist" width="100%">
										...
										<s:iterator var="cs" value="pageBean.list" status="vs">
											<tr>
												<td><s:property value="#vs.count"/> </td>
												<td><s:property value="#cs.csname"/></td>
												<td>
													<a style="color:#3366cc;" href="${pageContext.request.contextPath}/adminCategorySecond_editPage?csid=<s:property value="#cs.csid"/>">编辑</a><span class="lr10">|</span>
													<a style="color:#ff6600;" href="javascript:void(0);" title1="${pageContext.request.contextPath}/adminCategorySecond_delete?csid=<s:property value="#cs.csid"/>" class="alert-api-button alert-btn4">删除</a>
												</td>
											</tr>
										</s:iterator>
									</table>
										 ...
										 <!-- 动态显示条 -->
							       		 <s:iterator begin="pageBean.start" end="pageBean.end" var="num">
							       		 	<s:if test="pageBean.page != #num">
							        	  		<a href="${pageContext.request.contextPath}/adminCategorySecond_findAll?page=<s:property value="#num"/>" ><s:property value="#num"/></a>
							        	  	</s:if>
							        	  	<s:else>
