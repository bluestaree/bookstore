...
<body>
  <div style="background-color: #E7E7E7;border-radius: 20px;padding: 5px;margin-right: 5px;margin-top: 5px;margin-left: 5px;">
	...
	<form id="form1" action="${pageContext.request.contextPath}/adminCategorySecond_save" method="post">
	<table width="100%">
			<tbody>
				<tr>
				<td valign="top">
						<div class="title"><h2>添加二级分类</h2></div>
						<div class="maincon">
					<table class="formtable" width="100%">
						<tr>
							<td width="180px" align="right">二级分类名称：</td>
							<td>
								<div class="stext"><input type="text" id="csname" name="csname" value=""  style="width:180px;" /><span id="tip" style="margin-left: 15px;display: none;color: red"></span></div>
							</td>
