       ...
       $(document).ready(function(){
	      ...
	      //自定义每页商品显示数目
	       $("#limit").change(function(){
		     location.href="${pageContext.request.contextPath}/user_findLikeByUid?page=1&limit="+$(this).val();
	      }); 
       })
  </script>
  ...
  <section id="main">
    <div class="container_12">
       ...
       <div id="content" class="grid_9">
	      <h1 class="page_title">我的收藏<span style="padding-left: 20px;font-size: 12px;color: #e0e0e0;">Wish List</span></h1>
	      
	       <div class="options">
	       	<div class="grid-list">
				<a class="list" style="background: #f5f7f9;opacity: unset;"><span>img</span></a>
				<div style="width: 180px;margin-top: 20px;margin-left: 80px;">已收藏的商品列表</div>
		     </div><!-- .grid-list -->
		     <div class="show">
			    	每页显示记录数
	      ...
	      <s:else>
	      <s:iterator var="w" value="pageBean.list">
			<div class="product_li">
				<div class="grid_3">
					<div class="prev">
						<a href="${pageContext.request.contextPath}/product_findByPid?pid=<s:property value="#w.product.pid"/>"><img src="${pageContext.request.contextPath}/<s:property value="#w.product.image"/>" /></a>
					</div><!-- .prev -->
				</div><!-- .grid_3 -->
				
				<div class="grid_4">
					<div class="entry_content">
						<a href="${pageContext.request.contextPath}/product_findByPid?pid=<s:property value="#w.product.pid"/>"><h3 class="title" style="font-weight:  700;"><s:property value="#w.product.pname"/></h3></a>
						<div class="review">
							作者:&nbsp;<s:property value="#w.product.author"/>&nbsp;&nbsp;&nbsp;&nbsp;出版社:&nbsp;<s:property value="#w.product.press"/>
						</div>
						<p><s:property value="#w.product.spoint"/></p>
						<a>收藏时间:&nbsp;<s:property value="#w.wdate.toLocaleString()"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/user_cancelLike?wid=<s:property value="#w.wid"/>" style="color: red;margin-left: 40px;">取消收藏</a>
					</div><!-- .entry_content -->
				</div><!-- .grid_4 -->
				...
				<div class="grid_2">
					<div class="cart">
						<div class="price">
							<div class="price_new">￥:<s:property value="#w.product.shop_price"/>0</div>
							<div class="price_old" style="text-decoration:line-through;">￥:<s:property value="#w.product.market_price"/>0</div>
						</div>
						<a class="bay" href="${pageContext.request.contextPath}/product_findByPid?pid=<s:property value="#w.product.pid" /> ">查看商品详情</a>
						<a title="同类书籍" href="${pageContext.request.contextPath}/product_related?pid=<s:property value="#w.product.pid"/>&csid=<s:property value="#w.product.categorySecond.csid"/>&page=1&limit=6" class="obn"></a>
						<a class="like" style="background-image: none;"><span title="添加到购物车" title1="<s:property value="#w.product.pid" />" style="width: 42px; height: 40px;background: url(${pageContext.request.contextPath}/images/bg_bay.png) no-repeat 50% 50%;padding-left: 0px;padding-right: 0px;" class="alert-api-button alert-btn1"></span></a>
					</div><!-- .cart -->
				</div><!-- .grid_2 -->
	    ...
	    <div class="clear"></div>
	      ...
	      <div class="pagination">
			     ...
			     <s:if test="pageBean.page != 1">
			     	<li class="prev"><a href="${pageContext.request.contextPath}/user_findLikeByUid?page=1&limit=<s:property value="pageBean.limit"/>">&lt;&lt;</a></li>
				    <li class="prev"><a href="${pageContext.request.contextPath}/user_findLikeByUid?page=<s:property value="pageBean.page - 1"/>&limit=<s:property value="pageBean.limit"/>">&lt;</a></li>
				 </s:if>   
				 <!-- 动态显示条 -->
	       		 <s:iterator begin="pageBean.start" end="pageBean.end" var="num">
	       		 	<s:if test="pageBean.page != #num">
	        	  		<li><a href="${pageContext.request.contextPath}/user_findLikeByUid?page=<s:property value="#num"/>&limit=<s:property value="pageBean.limit"/>" ><s:property value="#num"/></a></li>
	        	  	</s:if>
	        	  	<s:else>
				  ...
				  <s:if test="pageBean.page != pageBean.totalPage">  
				    <li class="next"><a href="${pageContext.request.contextPath}/user_findLikeByUid?page=<s:property value="pageBean.page + 1"/>&limit=<s:property value="pageBean.limit"/>">&gt;</a></li>
				    <li class="next"><a href="${pageContext.request.contextPath}/user_findLikeByUid?page=<s:property value="pageBean.totalPage"/>&limit=<s:property value="pageBean.limit"/>">&gt;&gt;</a></li>
				  </s:if>  
			     </ul>
	      </div><!-- .pagination -->
