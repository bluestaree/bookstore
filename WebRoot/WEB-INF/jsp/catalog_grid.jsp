   ...
   <script>
       $(document).ready(function(){
	      ...
	      $("#limitByCid").change(function(){
		     location.href="${pageContext.request.contextPath}/product_findByCid?cid="+$(this).attr("title")+"&page=1&limit="+$(this).val();
	      });   
	       $("#limitByCsid").change(function(){
		     location.href="${pageContext.request.contextPath}/product_findByCsid?csid="+$(this).attr("title")+"&page=1&limit="+$(this).val();
	      });            
       })
  </script>
       ...
       <div id="content" class="grid_9">
	      ...
	      <div class="options">
		     <div class="grid-list">
			   ...
			   <s:if test="cid != null">
			   	<a class="list" href="${pageContext.request.contextPath}/product_findByCidList?cid=<s:property value="cid"/>&page=<s:property value="pageBean.page"/>&limit=<s:property value="pageBean.limit"/>"><span>img</span></a>
			   </s:if>
			   <s:if test="csid != null">
			   	<a class="list" href="${pageContext.request.contextPath}/product_findByCsidList?csid=<s:property value="csid"/>&page=<s:property value="pageBean.page"/>&limit=<s:property value="pageBean.limit"/>"><span>img</span></a>
			   </s:if>
	      ...
	      <div class="pagination">
		      <s:if test="cid != null">
			     ...
			     <s:if test="pageBean.page != 1">
			     	<li class="prev"><a href="${pageContext.request.contextPath}/product_findByCid?cid=<s:property value="cid"/>&page=1&limit=<s:property value="pageBean.limit"/>">&lt;&lt;</a></li>
				    <li class="prev"><a href="${pageContext.request.contextPath}/product_findByCid?cid=<s:property value="cid"/>&page=<s:property value="pageBean.page - 1"/>&limit=<s:property value="pageBean.limit"/>">&lt;</a></li>
				 </s:if>   
				 <!-- 动态显示条 -->
	       		 <s:iterator begin="pageBean.start" end="pageBean.end" var="num">
	       		 	<s:if test="pageBean.page != #num">
	        	  		<li><a href="${pageContext.request.contextPath}/product_findByCid?cid=<s:property value="cid"/>&page=<s:property value="#num"/>&limit=<s:property value="pageBean.limit"/>" ><s:property value="#num"/></a></li>
	        	  	</s:if>
	        	  	<s:else>
				  ...
				  <s:if test="pageBean.page != pageBean.totalPage">  
				    <li class="next"><a href="${pageContext.request.contextPath}/product_findByCid?cid=<s:property value="cid"/>&page=<s:property value="pageBean.page + 1"/>&limit=<s:property value="pageBean.limit"/>">&gt;</a></li>
				    <li class="next"><a href="${pageContext.request.contextPath}/product_findByCid?cid=<s:property value="cid"/>&page=<s:property value="pageBean.totalPage"/>&limit=<s:property value="pageBean.limit"/>">&gt;&gt;</a></li>
				  </s:if>  
			     </ul>
		      </s:if>
		      <s:if test="csid != null">
		      	 <ul>
			     <s:if test="pageBean.page != 1">
			     	<li class="prev"><a href="${pageContext.request.contextPath}/product_findByCsid?csid=<s:property value="csid"/>&page=1&limit=<s:property value="pageBean.limit"/>">&lt;&lt;</a></li>
				    <li class="prev"><a href="${pageContext.request.contextPath}/product_findByCsid?csid=<s:property value="csid"/>&page=<s:property value="pageBean.page - 1"/>&limit=<s:property value="pageBean.limit"/>">&lt;</a></li>
				 </s:if>   
				 <!-- 动态显示条 -->
	       		 <s:iterator begin="pageBean.start" end="pageBean.end" var="num">
	       		 	<s:if test="pageBean.page != #num">
	        	  		<li><a href="${pageContext.request.contextPath}/product_findByCsid?csid=<s:property value="csid"/>&page=<s:property value="#num"/>&limit=<s:property value="pageBean.limit"/>" ><s:property value="#num"/></a></li>
	        	  	</s:if>
	        	  	<s:else>
	        	  		<li class="curent"><a><s:property value="#num"/></a></li>
	        	  	</s:else>
				  ...
				  <s:if test="pageBean.page != pageBean.totalPage">  
				    <li class="next"><a href="${pageContext.request.contextPath}/product_findByCsid?csid=<s:property value="csid"/>&page=<s:property value="pageBean.page + 1"/>&limit=<s:property value="pageBean.limit"/>">&gt;</a></li>
				    <li class="next"><a href="${pageContext.request.contextPath}/product_findByCsid?csid=<s:property value="csid"/>&page=<s:property value="pageBean.totalPage"/>&limit=<s:property value="pageBean.limit"/>">&gt;&gt;</a></li>
				  </s:if>  
			     </ul>
		      </s:if>
	      </div><!-- .pagination -->
