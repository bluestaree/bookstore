       ...
       $(document).ready(function(){
	      ...
	      //自定义每页显示商品数目 
	       $("#limit").change(function(){
		     location.href="${pageContext.request.contextPath}/product_findAll?page=1&limit="+$(this).val();
	      });            
       })
  </script>
  ...
  <section id="main">
    <div class="container_12">
       ...
       <div id="content" class="grid_9">
	      <h1 class="page_title">全部商品<span style="padding-left: 20px;font-size: 12px;color: #e0e0e0;">All Products</span></h1>
	      <div class="options">
		      <div class="grid-list">
			   <a class="grid curent" ><span>img</span></a>
			   <div style="width: 180px;margin-top: 20px;margin-left: 80px;">所有商品列表</div>
		     </div><!-- .grid-list -->
	      ...
	      <div class="pagination">
			     ...
			     <s:if test="pageBean.page != 1">
			     	<li class="prev"><a href="${pageContext.request.contextPath}/product_findAll?page=1&limit=<s:property value="pageBean.limit"/>">&lt;&lt;</a></li>
				    <li class="prev"><a href="${pageContext.request.contextPath}/product_findAll?page=<s:property value="pageBean.page - 1"/>&limit=<s:property value="pageBean.limit"/>">&lt;</a></li>
				 </s:if>   
				 <!-- 动态显示条 -->
	       		 <s:iterator begin="pageBean.start" end="pageBean.end" var="num">
	       		 	<s:if test="pageBean.page != #num">
	        	  		<li><a href="${pageContext.request.contextPath}/product_findAll?page=<s:property value="#num"/>&limit=<s:property value="pageBean.limit"/>" ><s:property value="#num"/></a></li>
	        	  	</s:if>
	        	  	<s:else>
				  ...
				  <s:if test="pageBean.page != pageBean.totalPage">  
				    <li class="next"><a href="${pageContext.request.contextPath}/product_findAll?page=<s:property value="pageBean.page + 1"/>&limit=<s:property value="pageBean.limit"/>">&gt;</a></li>
				    <li class="next"><a href="${pageContext.request.contextPath}/product_findAll?page=<s:property value="pageBean.totalPage"/>&limit=<s:property value="pageBean.limit"/>">&gt;&gt;</a></li>
				  </s:if>  
			     </ul>
	      </div><!-- .pagination -->
